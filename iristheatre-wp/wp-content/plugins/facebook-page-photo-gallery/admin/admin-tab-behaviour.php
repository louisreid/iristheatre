							...
							<td>
								<fieldset>
									...
									<label for="imageScale">
										<input type="checkbox" name="fppg[fppg_imageScale]" id="imageScale"<?php if ($settings['fppg_imageScale']) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="centerOnScroll">
										<input type="checkbox" name="fppg[fppg_centerOnScroll]" id="centerOnScroll"<?php if ($settings['fppg_centerOnScroll']) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnContentClick">
										<input type="checkbox" name="fppg[fppg_hideOnContentClick]" id="hideOnContentClick"<?php if ($settings['fppg_hideOnContentClick']) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnOverlayClick">
										<input type="checkbox" name="fppg[fppg_hideOnOverlayClick]" id="hideOnOverlayClick"<?php if ($settings['fppg_hideOnOverlayClick']) echo ' checked="yes"';?> />
						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<label for="enableEscapeButton">
										<input type="checkbox" name="fppg[fppg_enableEscapeButton]" id="enableEscapeButton"<?php if ($settings['fppg_enableEscapeButton']) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="cyclic">
										<input type="checkbox" name="fppg[fppg_cyclic]" id="cyclic"<?php if ($settings['fppg_cyclic']) echo ' checked="yes"';?> />
