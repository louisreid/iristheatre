...
<div id="tribe-events-event-<?php echo $event_id ?>" class="month-view-event tooltip <?php tribe_events_event_classes() ?>" data-tribejson='<?php echo tribe_events_template_data( $post ); ?>'>
  <a href="<?php tribe_event_link( $post ); ?>" class="url">
    <div class="month-view-thumbnail" style="background-image: url('<?php the_field('image'); ?>');">
    </div>
  </a>
</div><!-- #tribe-events-event-# -->
<div class="hidden">
  <h3 class="tribe-events-month-event-title entry-title summary"><?php the_field('show-title'); ?></h3>
</div>
